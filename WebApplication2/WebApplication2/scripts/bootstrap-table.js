    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        $.each(this.options.columns, function (i, columns) {
            ...
            $.each(columns, function (j, column) {
                ...
                html.push(sprintf('<div class="th-inner checkbox %s">', that.options.sortable && column.sortable ?
                    'sortable both' : ''));
                ...
                if (column.checkbox) {
                    if (!that.options.singleSelect && that.options.checkboxHeader) {
                        ...
                        text = '<label><input name="btSelectAll" type="checkbox" /><span class="cr"><i class="cr-icon fa fa-square"></i></label>';
                    }
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                if (column.checkbox || column.radio) {
                    ...
                    text = [sprintf(that.options.cardView ?
                        '<div class="card-view %s">' : '<td class="bs-checkbox checkbox %s">', column['class'] || ''),
                        '<label><input' +
                        sprintf(' data-index="%s"', i) +
                        ...
                        ' /><span class="cr"><i class="cr-icon fa fa-square"></i></span></label>',
